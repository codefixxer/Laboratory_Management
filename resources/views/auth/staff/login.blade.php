...
<body>
    <div class="position-absolute top-0 end-0 p-3">
        <a href="{{ route('patient.login') }}" class="btn btn-light btn-lg text-dark border shadow-sm">Login as Patient</a>
    </div>
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="auth-title-section text-center mb-3">
                <h3>Welcome back</h3>
                <p>Sign in to continue to MediCore Laboratory</p>
            </div>
            @if($errors->any())
            ...
            <form id="loginForm" action="{{ route('login.post') }}" method="POST">
                ...
                <div class="role-btns d-flex flex-wrap gap-2 mb-3 justify-content-center">
                    <button type="button" class="btn" onclick="fillLogin('a@a', 'a')">Admin</button>
                    <button type="button" class="btn" onclick="fillLogin('r@r', 'a')">Receptionist</button>
                    <button type="button" class="btn" onclick="fillLogin('rp@r', 'a')">Reporter</button>
                    <button type="button" class="btn" onclick="fillLogin('s@s', 'a')">Sampler</button>
                    <button type="button" class="btn" onclick="fillLogin('m@m', 'a')">Manager</button>
                </div>
