    ...
    <div class="h-100" data-simplebar>
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a class="tp-link" href="{{ route('reporter.dashboard') }}">
                        <i data-feather="home" class="align-middle me-2 fs-18"></i>
                        <span> Dashboard</span>
                    </a>
                </li>
                <li>
                    <a class="tp-link" href="{{ route('reporter.reports') }}" >
                        <i class="mdi mdi-flask-outline align-middle me-2 fs-18"></i>
                        <span> Sampled Tests</span>
                    </a>
                </li>
       
<li>
    <a href="#sidebarviewrep" data-bs-toggle="collapse" aria-expanded="true" class="active">
        <i class="mdi mdi-file-document-multiple-outline align-middle me-2 fs-18"></i>
        <span> Report </span>
        <span class="menu-arrow"></span>
    </a>
    <div class="collapse show" id="sidebarviewrep">
