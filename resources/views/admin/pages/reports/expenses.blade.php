{{-- resources/views/admin/pages/reports/expenses.blade.php --}}
    ...
    <div class="col-md-4">
      <div class="card text-white bg-danger h-100">
        <div class="card-body">
          ...
          <p class="display-6" id="totalDebits">₹{{ number_format($totalDebits, 2) }}</p>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card text-white bg-warning h-100">
        <div class="card-body">
          ...
          <p class="display-6" id="totalStockCost">₹{{ number_format($totalStockCost, 2) }}</p>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card text-white bg-dark h-100">
        <div class="card-body">
          ...
          <p class="display-6" id="totalExpense">₹{{ number_format($totalExpense, 2) }}</p>
        </div>
      </div>
    </div>
  </div>
