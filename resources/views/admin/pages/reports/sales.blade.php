{{-- resources/views/admin/pages/reports/sales.blade.php --}}
...
<div class="container-fluid my-4">
  ...
  <div class="row g-3 mb-4">
    <div class="col-md-3">
      ...
      <input type="text" id="searchInput" class="form-control" placeholder="Search ID, Customer, Receptionist, Date...">
    </div>
    <div class="col-md-3">
      ...
      <table class="table table-hover mb-0" id="paymentsTable">
        ...
        <tbody>
          ...
          <tr
            ...
            data-receptionist-name="{{ strtolower($payment->customer->receptionist->name) }}"
          ...
          >
            ...
            <td>{{ $payment->customer->receptionist->name }}</td>
...
<script>
  ...
  function applyFilters() {
    ...
    rows.forEach(row => {
      ...
      const recName  = row.dataset.receptionistName;
